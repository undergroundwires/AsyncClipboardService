...
namespace AsyncWindowsClipboard.Native
{
    ...
    internal static partial class NativeMethods
    {
        ...
        /// </summary>
        /// <param name="uFormat">A clipboard format. For a description of the standard clipboard formats, see https://msdn.microsoft.com/en-us/library/windows/desktop/ms649013(v=vs.85).aspx#_win32_Standard_Clipboard_Formats .</param>
        /// <returns><p>If the function succeeds, the return value is the handle to a clipboard object in the specified format.</p>
        /// <p>If the function fails, the return value is <see langword="null" />. To get extended error information, call GetLastError. </p>
        /// </returns>
        /// <remarks>
        ...
        ///     <p>If the function fail. To get extended error information, call GetLastError.</p>
        /// </returns>
        /// <remarks>
        ///     <p>
        ...
        /// <summary>
        ///     <p></p>Places data on the clipboard in a specified clipboard format.
        ...
        ///     </p>
        ///     <p>
        ///         If <see cref="SetClipboardData" /> succeeds, the system owns the object identified by the hMem parameter. The
        ///         application may
        ...
        ///     the <c>WM_INITMENU</c> or <c>WM_INITMENUPOPUP</c> message. The application would then enable or disable the Paste menu item,
